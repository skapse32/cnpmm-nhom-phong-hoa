...
<style> 
	body {background: #EAF2D3;}
	table{font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; width:600px;border-collapse:collapse;}
	td, th{ font-size:1em;border:1px solid #98bf21;padding:3px 7px 2px 7px;}
	th {font-size:1.1em;text-align:left;padding-top:5px;padding-bottom:4px;background-color:#A7C942;color:#ffffff;}
	tr:nth-child(2n+1) td {color:#000000;background-color:#EAF2D3;}"
</style>
<script
...
<body>
	...
	<table width="650" border="1" align="center" >
		...
		<tr>
			<td colspan="3">Ngày sinh từ : <label for="startDate"></label> <input
				name="startDate" type="date" id="startDate" size="10"> Đến :
				<label for="endDate"></label> <input type="date" name="endDate"
				id="endDate"></td>
		</tr>
		<tr>
			<td colspan="3"><input type="button" name="search" id="search"
				value="Tìm" > <input type="reset"
				name="Reset" id="Reset" value="Reset"> <input type="button"
				name="luu" id="luu" value="lưu"> <input type="button"
				name="Load" id="Load" value="Load"></td>
		</tr>
		<tr>
